...
(function(window, angular, undefined) {'use strict';
     ...
     * # ngRoute
     *
     * The `ngRoute` module provides routing and deeplinking services and directives for lib apps.
     *
     * ## Example
   ...
   *      controller} if passed as a string.
        ...
        this.$get = ['$rootScope',
            ...
            function($rootScope, $location, $routeParams, $q, $injector, $http, $templateCache, $sce) {
                 ...
                 *          deps="lib-route.js" fixBase="true">
                 ...
                 *
                 *   <file name="script.js">
                 *     lib.module('ngRouteExample', ['ngRoute'])
                 *
 ...
 *                  $anchorScroll} to scroll the viewport after the view is updated.
     ...
     * @example
     ...
     deps="lib-route.js;lib-animate.js"
     ...
     <file name="script.js">
     lib.module('ngViewExample', ['ngRoute', 'ngAnimate'])
