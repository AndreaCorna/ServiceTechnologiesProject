...
angular.module("city/culture.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("city/culture.tpl.html",
    ...
    "                                    <img style=\"height: 220px;  width:100%;\" src=\"assets/images/empty_photo.png\"  alt=\"\" />\n" +
    "                                </div>\n" +
    "                                <div ng-if=\"c.photos.length!=0\">\n" +
    "                                    <img  style=\"height: 220px;  width:100%;\" src=\"{{c.photos[0].image}}\"  alt=\"\" />\n" +
    "                                </div>\n" +
    "                                <h4>{{c.name}}</h4>\n" +
    ...
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                    <button class=\"btn btn-default btn-sm capriola button-item\" ng-click=\"setCultureDetails(c.id)\" href=\"#moreInfoModalPlace\" data-toggle=\"modal\">\n" +
...
angular.module("city/entertainment.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("city/entertainment.tpl.html",
    ...
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                    <button class=\"btn btn-default btn-sm capriola button-item\" ng-click=\"setEntertainmentDetails(c.id)\" href=\"#moreInfoModalPlace\" data-toggle=\"modal\">\n" +
    "                                        Details <span class=\"glyphicon glyphicon-info-sign \"></span>\n" +
    "                                    </button>\n" +
...
angular.module("city/food.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("city/food.tpl.html",
    ...
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                    <button class=\"btn btn-default btn-sm capriola button-item\" ng-click=\"setFoodDetails(c.id)\" href=\"#moreInfoModalPlace\" data-toggle=\"modal\">\n" +
    "                                        Details <span class=\"glyphicon glyphicon-info-sign \"></span>\n" +
    "                                    </button>\n" +
...
angular.module("city/hotel.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("city/hotel.tpl.html",
    ...
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                    <button class=\"btn btn-default btn-sm capriola button-item\" ng-click=\"setHotelDetails(c.id)\" href=\"#moreInfoModalPlace\" data-toggle=\"modal\">\n" +
    "                                        Details <span class=\"glyphicon glyphicon-info-sign \"></span>\n" +
    "                                    </button>\n" +
...
angular.module("city/utility.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("city/utility.tpl.html",
    ...
    "                                        </div>\n" +
    "                                    </div>\n" +
    "                                    <button class=\"btn btn-default btn-sm capriola button-item\" ng-click=\"setUtilityDetails(c.id)\" href=\"#moreInfoModalPlace\" data-toggle=\"modal\">\n" +
    "                                        Details <span class=\"glyphicon glyphicon-info-sign \"></span>\n" +
    "                                    </button>\n" +
